...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data"  swalOnSuccess="تم تحديث البيانات بنجاح" swalOnFail="فشل في التحديث">
                {{ csrf_field() }}
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="file" id="image" name="image" type="file" class="dropify"  />
                </div>
                <div>
